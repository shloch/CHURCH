...
<link rel="stylesheet" href="<?php echo base_url() ?>css/form.css" media="screen">
    ...
    <form action="<?php echo base_url() . 'index.php/Admin_mess_evenement/save_deroulement/'.$calenderID; ?>" method="POST" id="signIn">
        <fieldset>
            <!-- Email -->
            ...
            <div>
                    ...
                    <input type="text" name="deroulement" value="" size="50" placeholder="EX: MESSES COMPLETES,PSAUMES,COMMUNION"/> <br/> <br/>
