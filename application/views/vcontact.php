<secton id="jumbotron">
		<div class="member-title">
			<h3 class="membres">Comment nous joindre</h3>
		</div>
		<div class="jumbotron">
            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  ...
                  <a href="#"><i class="fa fa-whatsapp" style="font-size:48px;color:#2c7f46"></i></a>
                </div>
            </div>
        </div>
		</section>
	<section id="googleMap">
		<h4>RETROUVEZ NOUS A YAOUNDE</h>
		<div class="mapouter">
			<div class="gmap_canvas">
				<iframe width="100%" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=%22Nkoldongo%20yaounde%22&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.crocothemes.net"></a>
			</div>
		</div>
	</section>